      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-navy leading-[1.1] mt-3">
              Where properties meet
              <br />
              the right agent
            </h1>
            
            <GoldDivider className="mt-5 mb-6 md:mx-0 mx-auto" />
            
            <p className="text-text-secondary text-lg leading-relaxed max-w-xl md:mx-0 mx-auto">
            ...
            <div className="mt-8 flex gap-3 flex-wrap justify-center md:justify-start">
              <Link href={ROUTES.submitLead}>
                <Button
                  size="lg"
                  className="bg-navy text-gold hover:bg-navy/90 h-12 px-8 text-sm font-medium"
                >
              ...
              <Link href={ROUTES.agents}>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-navy text-navy hover:bg-navy hover:text-gold h-12 px-8 text-sm font-medium"
                >
                  Browse agents →
                </Button>
              </Link>
            ...
            <div className="mt-6 flex items-center gap-3 justify-center md:justify-start">
              <AvatarStack />
              <span className="text-text-muted text-sm">Join 8,500+ happy property owners</span>
            </div>
          </div>

          {/* Right column - Property pills */}
          <div className="md:col-span-5 relative hidden md:block h-80">
            <div className="absolute inset-0 grid grid-cols-2 gap-3 content-center">
              {propertyPills.map((pill, i) => (
                <div
                  key={i}
                  className={`bg-white border border-ef-border shadow-none rounded-md px-4 py-3 ${pill.rotation}`}
                >

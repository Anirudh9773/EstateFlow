  ...
  const localAgents = [
    {
      ...
      commission: 1.5,
      fee: "1.5% commission",
      trustpilot_username: "savills",
      trustpilot_rating: 4.8,
      trustpilot_review_count: 127,
      google_place_id: "ChIJtX_S0LQDdkgR36h1Z2VwA5E",
      google_rating: 4.9,
      google_review_count: 34,
      allagents_username: "savills-london",
      allagents_rating: 4.7,
      allagents_review_count: 82
    },
    {
      id: "local-2",
      name: "James Thompson",
